...
REVOKE ALL ON entry_line_results      FROM offleash_tenant;
REVOKE ALL ON entry_lines             FROM offleash_tenant;
REVOKE ALL ON entries                 FROM offleash_tenant;
REVOKE ALL ON teams                   FROM offleash_tenant;
REVOKE ALL ON dog_sport_participation FROM offleash_tenant;
REVOKE ALL ON dog_titles              FROM offleash_tenant;
REVOKE ALL ON dogs                    FROM offleash_tenant;
REVOKE ALL ON owners                  FROM offleash_tenant;
