...
REVOKE ALL ON user_club_roles  FROM offleash_tenant;
REVOKE ALL ON users            FROM offleash_tenant;
REVOKE ALL ON clubs            FROM offleash_tenant;
REVOKE ALL ON canonical_classes FROM offleash_tenant;
REVOKE ALL ON akc_fee_schedules FROM offleash_tenant;
REVOKE ALL ON registries        FROM offleash_tenant;
REVOKE USAGE ON SCHEMA public FROM offleash_tenant;
